    ...
    <Layout home>
      ...
      <div className="flex-container gap-8 items-center justify-center">
        ...
        <div className="flex-auto flex-col items-center justify-center gap-4">
          ...
          <br/><br/>
          Now, as Head of Engineering at <Link href="https://www.chatwoot.com" target="_blank">Chatwoot</Link>, I continue to explore the fascinating world of technology while pursuing my 
